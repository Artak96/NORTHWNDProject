...
namespace NorthWndDAL.Migrations
{
    ...
    [Migration("20210331164817_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.CustomerCustomerDemo", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasMaxLength(5)
                        .HasColumnType("nchar(5)")
            ...
            modelBuilder.Entity("Core.Entities.EmployeeTerritory", b =>
                {
                    b.Property<int>("EmployeeId")
                        .HasColumnType("int")
                        .HasColumnName("EmployeeID");
            ...
            modelBuilder.Entity("Core.Entities.HelloApp", b =>
                {
                    b.Property<int?>("Age")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.CustomerCustomerDemo", b =>
                {
                    ...
                    b.HasOne("Core.Entities.CustomerDemographic", "CustomerType")
                        .WithMany("CustomerCustomerDemos")
            ...
            modelBuilder.Entity("Core.Entities.EmployeeTerritory", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Territory", "Territory")
                        .WithMany("EmployeeTerritories")
